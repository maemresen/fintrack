...
@Slf4j
public class ITDataExtension implements BeforeAllCallback, ParameterResolver {
    ...
    public void beforeAll(ExtensionContext extensionContext) throws Exception {
        ...
        var dataSourcePath = itData.dataSourcePath();
        ...
        try (InputStream resourceStream = getClass().getClassLoader().getResourceAsStream(dataSourcePath)) {
            ...
            var dataLoader = applicationContext.getBean(itData.dataLoader());
